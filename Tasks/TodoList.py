...
st.write('restylisé Heatmap TREEMAP BOUFFON')
st.write('Compléter S&P 500 Stocks Screener tab avec des nouvelles colonnes')
st.write("ajouter données dans Options strat à la place de X et Y (graph prix ....), restyliser l'ajout d'options avec les bonnes couleurs")
